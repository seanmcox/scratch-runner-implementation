...
public class MonitorNormal extends MonitorComponent{
	 ...
	 * 
	 */
	public MonitorNormal(StageMonitorImplementation monitor, ScratchRuntimeImplementation runtime) {
		super(monitor);
		...
		add(label);
		add(new MonitorValueComponent(monitor.getCmd(), monitor.getParam(), monitor.getTarget(), new Color(monitor.getColor()), FONT_NORMAL, getFontMetricsNormal(), runtime));
