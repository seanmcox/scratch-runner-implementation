...
public class ListImplementationTest {
	...
	public void testConstructor() {

		{
			...
			String name = "egg";
			ListImplementation list = new ListImplementation(name, listContents, 0.0, 1.0, 100.0, 101.0, false, runtime);
...

		{
			...
			String name = "salad";
			ListImplementation list = new ListImplementation(name, listContents, 2.0, 3.0, 104.0, 105.0, true, runtime);
			assertEquals(name, list.getListName());
