	...
	public void testConstructor() {
		{
			...
			SpriteImplementation sprite = new SpriteImplementation(
					...
					0, 1, 2, 3, 1.5, Sprite.ROTATION_STYLE_NORMAL, false, 0, true, new HashMap<String,Object>(), new FakeStage());
...

		{
			...
			listMap.put("testList", new ListImplementation("testList", new Object[0], 0.0, 0.0, 0.0, 0.0, false));
			...
			SpriteImplementation sprite = new SpriteImplementation(
					...
					1, 5, 6, 7, 0.5, Sprite.ROTATION_STYLE_NONE, false, 0, false, spriteInfo, new FakeStage());
			assertEquals(name, sprite.getObjName());
